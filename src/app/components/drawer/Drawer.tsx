const Drawer = (props) => {
    return (
        <div id={`drawer-navigation`}
             className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform ${props.visibility ? null : '-translate-x-full'} bg-white dark:bg-gray-800`}
            ...
            <button type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation"
                ...
                <span className="sr-only" onClick={props.onClose}>Close menu</span>
            </button>
